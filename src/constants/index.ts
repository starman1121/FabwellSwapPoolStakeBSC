...
export const USDC = new Token(ChainId.BSC, '0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d', 18, 'USDC', 'Binance-Peg USD Coin')
...
export const WMATIC = new Token(ChainId.BSC, '0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d', 18, 'USDC', 'Binance-Peg USD Coin' )
...
export const WELT = new Token(ChainId.BSC, '0x1785113910847770290f5f840b4c74fc46451201', 18, 'WELT', 'FEBWELT')//bluesky maintoken
...
const UNI_ADDRESS = '0x1785113910847770290f5f840b4c74fc46451201'//main token ex: cake(pancakeswap) Bluesky
