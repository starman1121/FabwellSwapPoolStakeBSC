            ...
            <TopSection gap="md" justify="center">
                <DataCard>
                    ...
                    <CardSection>
                        <AutoColumn gap="md">
                            <RowBetween>
                                <TYPE.white fontWeight={600}>NFT-Staking</TYPE.white>
                            </RowBetween>
                            <RowBetween>
                                <TYPE.white fontSize={14}>
                                    Deposit your NFT tokens to receive WELT or MATIC.
                                </TYPE.white>
                            </RowBetween>{' '}
                            <ExternalLink
                ...
                <PoolSection>
                    {stakingRewardsExist && stakingInfos?.length === 0 ? (
                        ...
                        stakingInfos?.map(stakingInfo => {
                            ...
                            return (stakingInfo.isNftToken ? <PoolCard key={stakingInfo.stakingRewardAddress} stakingInfo={stakingInfo} />
                                : <></>)
                        })
                    )}
                </PoolSection>
