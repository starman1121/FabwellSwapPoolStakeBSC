...
const AccountElement = styled.div<{ active: boolean }>`
  ...
  background-color: ${({ theme, active }) => (!active ? theme.bg1 : 'rgb(220, 81, 136)')};
  border-radius: 12px;
  white-space: nowrap;
  width: 100%;
  cursor: pointer;
...
export default function Header() {
  ...
  {/*        <StyledNavLink id={`stake-nav-link`} to={'/farm'}>
          ...
          <StyledNavLink id={`stake-nav-link`} to={'/redeem'}>
            Redeem
          </StyledNavLink> */}
          <StyledNavLink id={`stake-nav-link`} to={'/stake'}>
            Stake
          </StyledNavLink>
          {/* <StyledNavLink id={`stake-nav-link`} to={'/nft-stake'}>
            nft-stake
          </StyledNavLink> */}
      ...
      <HeaderControls>
        <HeaderElement>
          <MenuItem id="link" target="_self" href="https://defi.fabwelt.com/polygon">
            Polygon
          </MenuItem>
          <HideSmall>
            ...
            <UNIWrapper onClick={toggleClaimModal}>
              <UNIAmount active={!!account && !availableClaim} style={{ pointerEvents: 'auto' }}>
                <TYPE.white padding="0 2px">
                  {claimTxn && !claimTxn?.receipt ? <Dots>Claiming WELT</Dots> : 'Claim UNI'}
                </TYPE.white>
              </UNIAmount>
              <CardNoise />
            </UNIWrapper>
          ...
          {!availableClaim && aggregateBalance && (
            <UNIWrapper onClick={() => setShowUniBalanceModal(true)}>
              <UNIAmount active={!!account && !availableClaim} style={{ pointerEvents: 'auto',background:'rgb(220, 81, 136)' }}>
                {account && (
                  <HideSmall>
                    <TYPE.white
                      style={{
